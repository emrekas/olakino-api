...
{
    public partial class OlakinoTablesAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    MealsJson = table.Column<string>(type: "TEXT", nullable: false),
                    TotalCalorie = table.Column<int>(type: "INTEGER", nullable: false),
                    DietCategoryId = table.Column<int>(type: "INTEGER", nullable: false),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: true),
                    LastModified = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityLogs_Exercises_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_ExerciseId",
                table: "ActivityLogs",
                column: "ExerciseId");
